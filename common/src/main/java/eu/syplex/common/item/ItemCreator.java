...
public abstract class ItemCreator implements Builder<ItemStack> {
	...
	/**
	 * Adds persistent data to the item mapped to the {@link NamespacedKey}. Those are nbt-data.
	 *
	 * @param key  The mapping key
	 * @param type The {@link PersistentDataType} to set
	 * @param data The data to set
	 * @param <T>  The datatype of the data
	 * @param <Z>  The datatype of the data
	 *
	 * @return The current object instance
	 */
	public abstract <T, Z> ItemCreator persistentData(@NotNull NamespacedKey key, @NotNull PersistentDataType<T, Z> type, @NotNull Z data);
